      ...
      <div className="md:ml-64 p-6">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-3xl font-bold text-[#2C3E50]">{materials.length}</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg font-bold text-[#2C3E50]">🏪 Store Profile</h2>
            <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link
              ...
              className="bg-[#F47B20] text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-[#E06B10] transition"
            >
              + Manage Materials
            </Link>
          </div>
          {materials.length > 0 ? (
            <div className="overflow-x-auto">
              ...
              {materials.length > 5 && (
                <p className="text-sm text-gray-500 mt-2">+ {materials.length - 5} more materials</p>
              )}
            </div>
          ) : (
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-6">
          ...
          >
            ...
            <h3 className="font-bold text-[#2C3E50]">Add Materials</h3>
            <p className="text-sm text-gray-500">Upload your price list</p>
          </Link>
          <Link
            href="/dashboard/hardware/subscription"
            className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 text-center hover:shadow-lg transition"
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 text-center hover:shadow-lg transition cursor-pointer">
            ...
            <p className="text-sm text-gray-500">View store performance</p>
          </div>
        </div>
      </div>
    </div>
