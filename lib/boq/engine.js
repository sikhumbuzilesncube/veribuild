...
// ------------------------------------------------------------
// Rate lookup: map BOQ item code to a price.
// Updated in Batch 4 to include A.1-A.3 and realistic E.3-E.4.
// ------------------------------------------------------------
function getRateForItem(item) {
  const map = {
    // Substructure
    'A.1':   0.50,               // site clearance per m2
    'A.2':   12.50,              // excavation per m3
    'A.3':   8.00,               // backfill per m3
