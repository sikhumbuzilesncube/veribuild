...
// ----------------------------------------------------------
const isRuralStructure = structureType !== 'house'
  && structureType !== 'cottage'
  && structureType !== 'outbuilding'
...
const roofItems = calcRoof(inputs, DEFAULT_PRICES, isRuralStructure);
...
function getRateForItem(item) {
  const map = {
    ...
    // Rural roof codes (C.R prefix)
    'C.R1':   DEFAULT_PRICES.purlin_50x75,
    'C.R2':   DEFAULT_PRICES.roofing_ibr_sheet,
    'C.R2.1': 0.30,
    'C.R2.2': DEFAULT_PRICES.ridge_cap_m,
    'C.R2.3': DEFAULT_PRICES.barge_board_m,
    'C.R3':   DEFAULT_PRICES.roof_timber_50x50 / 3,
