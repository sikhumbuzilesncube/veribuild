...
// Site clearance, excavation, foundation, hardcore, DPC
// ============================================================
...
export function calcSubstructure(inputs, prices) {
  ...
  items.push({
    ...
    unit: 'm3',
    qty: round1(excavationVolume * 0.35),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
  ...
  items.push({
    ...
    unit: 'm3',
    qty: round1(floorArea * SITE.hardcoreThickness_m),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
  ...
  items.push({
    ...
    unit: 'm3',
    qty: round1(floorArea * SITE.sandBlindingThickness_m),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
  ...
  items.push({
    ...
    unit: 'l',
    qty: round1(floorArea * SITE.termiteLiquidLPerM2),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
  ...
  // A.8 Foundation concrete (header)
  ...
  items.push({
    ...
    unit: 'bag',
    qty: ceilNum(withWaste(foundationConcreteVolume * mix.cement, WASTE.cement)),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
  ...
  items.push({
    ...
    section: 'A',
    source: 'formula',
    formula: 'concreteVolume * 90 kg/m3 * 1.05',
  });

  // A.10 Foundation brickwork (header)
  const foundationWallHeight = 0.45;
  ...
  items.push({
    ...
    unit: 'nr',
    qty: ceilNum(withWaste(foundationWallArea * BRICKS_PER_M2.oneBrick, WASTE.bricks)),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
  ...
  items.push({
    ...
    section: 'A',
    source: 'formula',
    formula: 'wallArea * 0.04 m3/m2 * 7.5 bags/m3 * 1.05',
    parentCode: 'A.10',
  });
  ...
  items.push({
    ...
    section: 'A',
    source: 'formula',
    formula: 'wallArea * 0.04 m3/m2 * 1.5 m3/m3 * 1.10',
    parentCode: 'A.10',
  });
  ...
  items.push({
    ...
    unit: 'm',
    qty: round1(foundationWallArea * REINFORCEMENT_ACCESSORIES.brickforcePerM2),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
    formula: 'wallArea * 2.94 m/m2',
  });
  ...
  items.push({
    ...
    unit: 'gang-day',
    qty: round1(excavationVolume / excOutputPerDay),
    category: 'Substructure',
    section: 'A',
    source: 'formula',
