...
// Ground slab, walls, lintels, wall plate ties
// ============================================================

import { CONCRETE_MIX, MORTAR_MIX, MORTAR_PER_M2, BRICKS_PER_M2,
         WASTE, REINFORCEMENT_ACCESSORIES, LABOUR_PRODUCTIVITY } from '../conversions.js';
...
export function calcSuperstructure(inputs, prices) {
  ...
  items.push({
    ...
    unit: 'sheet',
    qty: ceilNum((floorArea * 1.1) / 14.4),
    category: 'Superstructure',
    section: 'B',
    source: 'formula',
  ...
  // B.3 Walls (header)
  const openingArea = doors * 1.8 + windows * 1.5;
  ...
  items.push({
    ...
    section: 'B',
    source: 'formula',
    formula: 'netWallArea * 0.04 m3/m2 * 7.5 bags/m3 * 1.05',
    parentCode: 'B.3',
  });
  ...
  items.push({
    ...
    section: 'B',
    source: 'formula',
    formula: 'netWallArea * 0.04 m3/m2 * 1.5 m3/m3 * 1.10',
    parentCode: 'B.3',
  });
  ...
  items.push({
    ...
    unit: 'm',
    qty: round1(netWallArea * REINFORCEMENT_ACCESSORIES.brickforcePerM2),
    category: 'Superstructure',
    section: 'B',
    source: 'formula',
    formula: 'netWallArea * 2.94 m/m2',
  });
  ...
  items.push({
    ...
    unit: 'gang-day',
    qty: round1(totalBricks / bricksPerGangDay),
    category: 'Superstructure',
    section: 'B',
    source: 'formula',
