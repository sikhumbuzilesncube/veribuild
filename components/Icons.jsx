...
// All inline SVG icons for VeriBuild.
// Import individually: import { IconUpload, IconCheck } from '@/components/Icons';

export const IconUpload = ({ className = 'w-6 h-6' }) => (
...
export const IconDocument = ({ className = 'w-6 h-6' }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
